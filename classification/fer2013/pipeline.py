...
def run_pipeline(max_iter=10, patience=5):
    ...
    """
    # --- Initial Setup ---
    assets_dir = './assets/fer2013'
    weights_dir = './weights'
    logs_dir = './logs'
    python_scripts_dir = './python_scripts/pipeline_fer2013' 
    
    os.makedirs(weights_dir, exist_ok=True)
    os.makedirs(logs_dir, exist_ok=True)

    classes_file = os.path.join(assets_dir, 'fer2013_classes.txt')
    ...
    mbm_model_path = os.path.join(weights_dir, 'mbm_model_fer2013.pth')
    global_best_weights_path = os.path.join(weights_dir, 'mbm_model_global_best_fer2013.pth')
    
    metrics_csv_path = os.path.join(logs_dir, 'metrics_history_fer2013.csv')
